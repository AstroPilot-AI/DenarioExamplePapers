# filename: codebase/dimensionality_reduction_and_baseline_feature_construction.py
import numpy as np
import torch
...
all_lh_ids_original = np.array([data.lh_id for data in full_dataset_original])  # MODIFIED: Removed .item()
